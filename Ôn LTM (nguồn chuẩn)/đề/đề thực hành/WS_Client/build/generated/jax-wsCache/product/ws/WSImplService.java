 ...
 * 
 */
@WebServiceClient(name = "WSImplService", targetNamespace = "http://WS/", wsdlLocation = "http://localhost:50000/product?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:50000/product?wsdl");
